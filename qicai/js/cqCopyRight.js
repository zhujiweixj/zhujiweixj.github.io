...
+'				<span class="SDGCOPYRIGHT-pr3">本网站设计及美工由<a href="http://www.1xlala.com" target="_blank" title="一休独家设计" > 一休论坛</a>独家设计制作 拒绝盗版</span>'
+'			</p>'
+'		</div>'
//右侧网络警察3个图标
+'		<div class="SDGCOPYRIGHT-priv">'
+'			<a href="http://www.1xlala.com" class="SDGCOPYRIGHT-priv1" target="_blank"></a>'
+'			<span>'
+'			</span>'
+'		</div>'
